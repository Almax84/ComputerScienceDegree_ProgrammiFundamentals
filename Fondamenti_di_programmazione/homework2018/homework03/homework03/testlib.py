...
class TestCase(unittest.TestCase):
    ...
    def assert_forbidden(self, forbidden):
        # lancia una eccezione (è necessario usare unittest.mock.patch sulla funzione proibita)
        # TODO: farne un contesto da usare con with
        raise ForbiddenError("E' proibito usare {}".format(forbidden))
    ...
    def forbidden_function(self, target='builtins.print'):
        ...
        return unittest.mock.patch(target, new=lambda *x: self.assert_forbidden( target ))
    ...
    def ignored_function(self, target='builtins.print'):
        ...
        return unittest.mock.patch(target, new=lambda *x: None)
    ...
    def check_img_file(self, a,b):
        ...
        self.assertEqual(wa, wb, "images have different width {} != {})".format(wa,wb))
        self.assertEqual(ha, hb, "images have different height {} != {})".format(ha,hb))
        for y in range(ha):
            for x in range(wa):
